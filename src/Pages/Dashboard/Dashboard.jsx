...
const Dashboard = () => {
    ...
    return (
        <div className="py-8">
            ...
            {/* Dashboard Section */}
            <div className="grid grid-cols- gap-4 md:grid-cols-3 mt-4 px-4">
                {/* Total Users Card */}
                <Link
                    to={"/users"}
                    className="bg-purple-200 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer"
                >
                ...
                <Link
                    to={"/tasks"}
                    className="bg-pink-200 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer"
                >
                ...
                <Link
                    to={"/teams"}
                    className="bg-slate-200 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer"
                >
                ...
                {/* Pending Tasks Card */}
                <div className="bg-red-300 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer">
                ...
                <div className="bg-sky-300 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer">
                    <h2 className="text-lg font-semibold mb-2">
                        In Progress Tasks
                    </h2>
                ...
                <div className="bg-green-300 shadow-lg flex items-center justify-center flex-col h-[150px] p-4 rounded-md  cursor-pointer">
                    <h2 className="text-lg font-semibold mb-2">
                        Completed Tasks
                    </h2>
